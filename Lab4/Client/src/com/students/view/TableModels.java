...
public class TableModels {
    ...
    public static String getNames(List<String> entityIds) {        
    ...
    public static DefaultTableModel getCharacterTableModel(List<Персонаж> characters) {
        Object[][] data = new Object[characters.size()][4];
        for (int i = 0; i < characters.size(); i++) {
            Персонаж character = characters.get(i);
            data[i][0] = character.getActor();
            data[i][1] = character.getMovie();
